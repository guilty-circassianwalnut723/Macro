#!/usr/bin/env python3
"""
Generate images using the GPT API (images/edits).
...
def process_one_sample(
    ...
    if not images:
        print(f"[gpt] Skipping {task} idx={idx}: no valid input images")
        return False
    try:
