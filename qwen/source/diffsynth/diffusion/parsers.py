...
def add_image_size_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--max_pixels", type=int, default=1024*1024, help="Maximum number of pixels per output image, used for dynamic resolution.")
    parser.add_argument("--max_input_pixels", type=parse_max_input_pixels, default=None, 
                        help="Maximum pixels for input images (edit_image). Can be int or comma-separated list like OmniGen. "
                             "E.g., '1048576,1048576,1048576,589824,589824,589824,589824,589824,589824,589824'. "
                             "If not set, uses max_pixels.")
    return parser
